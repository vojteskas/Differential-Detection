#!/bin/bash
#PBS -N DP_FFDiffQuadratic2_DF21nonVC
...
name=DP_FFDiffQuadratic2_DF21nonVC
...
./train_and_eval.py --metacentrum --dataset ASVspoof2021DFDataset_nonVC_pair --extractor XLSR_300M --processor MHFA --classifier FFDiffQuadratic2 --num_epochs 20 2>&1
