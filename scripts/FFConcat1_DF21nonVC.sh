...
./train_and_eval.py --metacentrum --dataset ASVspoof2021DFDataset_nonVC_pair --extractor XLSR_300M --processor MHFA --classifier FFConcat1 --num_epochs 20 2>&1
