...
./train_and_eval.py --metacentrum --dataset ASVspoof2021DFDataset_VC_pair --extractor XLSR_300M --processor MHFA --classifier FFDiffAbs2 --num_epochs 20 2>&1
