...
./train_and_eval.py --metacentrum --dataset ASVspoof2021DFDataset_nonVC_single --extractor XLSR_300M --processor MHFA --classifier FF --num_epochs 20 2>&1
