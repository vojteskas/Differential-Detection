...
#PBS -l select=1:ncpus=4:mem=200gb:ngpus=1:gpu_mem=20gb:scratch_ssd=150gb
#PBS -m ae
...
./train_and_eval.py --metacentrum --dataset ASVspoof2019LADataset_pair --extractor XLSR_300M --processor MHFA --classifier FFConcat4 2>&1
./eval --metacentrum --checkpoint FFConcat4_20.pt --dataset ASVspoof2021DFDataset_pair --extractor XLSR_300M --processor MHFA --classifier FFConcat4 2>&1
./eval --metacentrum --checkpoint FFConcat4_20.pt --dataset InTheWildDataset_pair --extractor XLSR_300M --processor MHFA --classifier FFConcat4 2>&1
