#!/bin/bash
#PBS -N DP_XLSR_300M_MHFA_FFDiffQuadratic_DF21
...
name=DP_XLSR_300M_MHFA_FFDiffQuadratic_DF21
...
./train_and_eval.py --metacentrum --dataset ASVspoof2021DFDataset_pair --extractor XLSR_300M --processor MHFA --classifier FFDiffQuadratic --num_epochs 20 2>&1
