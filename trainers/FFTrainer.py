...
class FFTrainer(BaseTrainer):
    ...
    def train(self, train_dataloader, val_dataloader, numepochs=100, start_epoch=1):
        ...
        for epoch in range(start_epoch, start_epoch + numepochs):  # 1-indexed epochs
            ...
            # Training loop
            for wf, label in tqdm(train_dataloader):
            ...
            self.save_model(f"./FF_{epoch}.pt")
    ...
    def _plot_loss_accuracy(self, losses, accuracies, subtitle: str = ""):
        ...
        plt.legend()
        plt.title("FF Loss and Accuracy" + f" - {subtitle}" if subtitle else "")
        plt.xlabel("Epoch")
        plt.ylabel("Loss/Accuracy")
        plt.savefig(f"./FF_loss_acc_{subtitle}.png")
    ...
    def _plot_eer(self, eers, subtitle: str = ""):
        ...
        plt.legend()
        plt.title("FF EER" + f" - {subtitle}" if subtitle else "")
        plt.xlabel("Epoch")
        plt.ylabel("EER")
        plt.savefig(f"./FF_EER_{subtitle}.png")
